...
# =========================================================
# Mapping Network for disentangling z-space
# =========================================================
class MappingLayers(th.nn.Module):
    '''
    ...
    def __init__(self, z_dim, hidden_dim, w_dim):
        super().__init__()
        layers = [_equalized_linear(z_dim, hidden_dim), th.nn.ReLU()]
        for _ in range(4):
        ...
        self.mapping = th.nn.Sequential(*layers)
...
class GenInitialBlock(th.nn.Module):
    ...
    def __init__(self, in_channels, n_classes=10, use_eql=True):
        """
        ...
        if use_eql:
            self.conv_1 = _equalized_deconv2d(in_channels + n_classes, in_channels, (4, 4), bias=True)
            self.conv_2 = _equalized_conv2d(in_channels, in_channels, (3, 3), pad=1, bias=True)

        else:
            self.conv_1 = ConvTranspose2d(in_channels + n_classes, in_channels, (4, 4), bias=True)
